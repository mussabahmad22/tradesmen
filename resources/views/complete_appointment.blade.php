    ...
    <table class="table table-report table-report--bordered display datatable w-full">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    {{  $value->status == 4 ? 'Completed': 'Pending' }}
                </td>
                <td>
                    <a class="flex items-center text-theme-1 mr-3  text-primary" href="{{route('user_appointment_details',['id' => $value->id])}}">
...
<div class="modal" id="delete-modal-preview">
    <div class="modal__content">
        ...
        <div class="px-5 pb-8 text-center">
            <form type="submit" action="{{ route('delete_complete_appointment') }}" method="post">
                @csrf
                @method('DELETE')
