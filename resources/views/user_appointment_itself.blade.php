<?php
$pagename="user_appointment_itself";
?>
...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto ml-2">
        List of Appointments Added By User
    </h2>
            ...
            <tr>
                ...
                <td>
                    <a class="flex items-center text-theme-1 mr-1"
                        href="{{route('edit_appointment_itself' , ['id' =>  $value->id])}}"><i data-feather="edit"
...
<div class="modal" id="delete-modal-preview">
    <div class="modal__content">
        ...
        <div class="px-5 pb-8 text-center">
            <form type="submit" action="{{ route('delete_appointment_itself') }}" method="post">
                @csrf
                @method('DELETE')
